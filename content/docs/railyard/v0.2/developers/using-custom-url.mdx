...
<img
  width="1000"
  alt="image"
  src="/images/docs/railyard/github-assets-sha256.png"
/>
...
Now that you have your Update JSON files set up, you can move on to actually [creating the submission ticket on the Railyard registry](/railyard/docs/v0.2/developers/publishing-projects#using-the-issue-template).
