...
From here, input a token name, and set the expiration to "No expiration". Under "Resource owner", select "All repositories". Under "Permissions", add a permission for "Contents" and set it to "Read-only". Finally, click "Generate token".
...
Make sure you save your token somewhere safe, as you will not be able to see it again after you navigate away from the page.
