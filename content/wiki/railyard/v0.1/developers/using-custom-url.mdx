...
Now that you have your Update JSON files set up, you can move on to actually [creating the submission ticket on the Railyard registry](/docs/railyard/v0.1/developers/publishing-projects#using-the-issue-template).
