...
For maps, use the ZIP that you made using the [custom map creation guide](/wiki/creating-custom-maps/creating-custom-maps-us).
...
Tags:            Select all tags that apply to your map. These help users find your 
                 map in the browser.

Data Source:     Enter the data source used to generate the demand data for your 
                 map. The source name should use common abbreviations like LODES/
                 INSEE/ONS etc. (optional, defaults to OSM)

Methodology:     The method used to generate the demand for your map. This 
                 defaults to raw OSM data, but if you used a different method
                 (e.g. using census data, manually enhancing OSM data, etc.) you
                 can specify that here.

Source Quality:  The quality of the data source you used. View Data Quality at
                 https://subwaybuildermodded.com/wiki/railyard/v0.1/developers/data-quality
                 for more information on how to categorize your data quality.

Level of Detail: The level of detail present in your map. View Data Quality at
                 https://subwaybuildermodded.com/wiki/railyard/v0.1/developers/data-quality
                 for more information on how to categorize your data quality.
...
GitHub Repo:     Required ONLY if using GitHub Releases. The owner/repo path (e.g. 
                 username/sb-raleigh) in plaintext, NOT a URL. The repo must exist, have at least one release, and the latest release must contain a .
...
Custom URL:      Required ONLY if you selected Custom URL. The full URL to your 
                 ...
                 Update JSON schema. Leave blank if using GitHub Releases. The guide 
                 for using an Update JSON can be found at: https://subwaybuildermodded.com/wiki/railyard/v0.1/developers/using-custom-url.

Gallery:         Drag and drop screenshots here, or paste image URLs (one per line). 
                 These will be displayed in the map browser. At least one image of your demand data is required.
```

:::danger[Data Source and Quality]

Railyard requires all map makers to submit the source and quality of their data. This is then used to categorize the data for users looking to download maps. For more detailed information on the specifications of data quality, see [**Data Quality**](/wiki/railyard/v0.1/developers/data-quality).
...
Custom URL:   Required if using Custom URL. The full URL to your self-hosted Update 
              ...
              blank if using GitHub Releases. The guide for using an Update JSON can be found at:
              https://subwaybuildermodded.com/wiki/railyard/v0.1/developers/using-custom-url.
