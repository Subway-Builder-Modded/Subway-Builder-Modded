...
export function SidebarPanel({
  ...
  useLayoutEffect(() => {
    ...
    let idealTop = getNavbarOffsetPx();

    const measureLayout = () => {
      idealTop = getNavbarOffsetPx();
    ...
    <>
      ...
      >
        ...
        <div className="group/sidebar relative flex min-h-0 flex-1 flex-col">
          <div
            ref={scrollRef}
            className="min-h-0 flex-1 overflow-y-auto overflow-x-clip px-[clamp(0.65rem,1.4vw,1rem)] py-3 [scrollbar-width:none] [-ms-overflow-style:none] [&::-webkit-scrollbar]:hidden"
