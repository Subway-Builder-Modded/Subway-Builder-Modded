            ...
            <NavigationMenuList>
              <NavigationMenuItem value={item.id}>
                <NavigationMenuTrigger
                  ...
                  onPointerLeave={() =>
                    setHoveredNavbarItemId((current) =>
                ...
                <NavigationMenuContent
                  className={cn(
                    'min-w-56 !bg-background ring-1 ring-border rounded-xl shadow-lg',
                    style?.dropdownContentClassName,
                  )}
                >
                      ...
                      return (
                        <li key={dropdownItem.id}>
                          <NavigationMenuLink
                            ...
                            target={
                              isExternalHref(dropdownItem.href)
                                ? '_blank'
                                : undefined
                            }
                            rel={
                            ...
                            onPointerEnter={() =>
                              setHoveredLeftDropdownItemId(dropdownHoverKey)
                            }
                            onPointerLeave={() =>
                              setHoveredLeftDropdownItemId((current) =>
                                current === dropdownHoverKey ? null : current,
                              )
                            }
                            onMouseEnter={() =>
                              setHoveredLeftDropdownItemId(dropdownHoverKey)
